...
FORMAT = "lunel-console-configuration"
VERSION = 1
...
WARNINGS = [
    "Sensitive plaintext: contains password hashes, Core API tokens, link identifiers and LUNEL_SECRET_KEY. Store encrypted offline; never publish.",
    ...
    "The target LUNEL_SECRET_KEY must match the backup to preserve endpoint tokens; configure it securely out of band before import. Changing it invalidates existing target endpoint tokens.",
]
